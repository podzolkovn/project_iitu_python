import pandas
from open_site import open_buy_krisha_aktau, open_buy_krisha_almaty, open_buy_krisha_astana, open_buy_krisha_shymkent
from math import ceil


def write_in_file_buy_aktau():
    info_buy = open_buy_krisha_aktau()
...
def check_file_buy_aktau():
    try:
        file_read = pandas.read_csv('date/buy_build_aktau.csv')
        print('Файлы уже получены город Актау')
        return file_read
    except FileNotFoundError:
        write_in_file_buy_aktau()
